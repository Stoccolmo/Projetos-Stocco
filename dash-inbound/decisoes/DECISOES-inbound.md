...
Propus unificar em "passe pela data da reunião" (base da meta/variável) migrando a aba Online vs Presencial e rotulando o Funil como "Agendado (entrada na etapa)". **Rodrigo decidiu desconsiderar: as duas bases ficam como estão.** O rótulo da aba (V21) já explica o universo.
